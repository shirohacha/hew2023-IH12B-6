  ...
  <body>
    <div id="global-container">
      <div id="container">
        ...
        <img src="../images/bg_20.png"></img>
        
        
        <div class="item_introduction"><span class="products__name02">Classic</span><span class="description02">誰にでもお勧めできる普通のゲーミングチェア</span><span class="price02">￥13,000+</span></div>
        ...
        <form action="./item_cart_a.php" method="post">
          ...
          <div class="modal_pop1">
            ...
            <div id="photo_canvas_id">
                  ...
                  <input type="hidden" name="product_name" value="Classic">
                  <input type="hidden" name="explanation" value="誰にでもお勧めできる普通のゲーミングチェア">
