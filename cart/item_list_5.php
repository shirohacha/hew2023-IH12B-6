...
<html lang="ja">
  <head>
    ...
    <!-- script.jsを読み込む -->
    <script src="../js/script_05_ffd6ff.js"></script>
    <script src="../js/script02_05_d6d6ff.js"></script>
    <script src="../js/script03_05_d6ffff.js"></script>
    <script src="../js/script04_05_d6ffd6.js"></script>
    <script src="../js/script05_05_ffffd6.js"></script>
    <script src="../js/script06_05_ffd6d6.js"></script>
  ...
  <body>
    <div id="global-container">
      <div id="container">
        ...
        <img src="../images/bg_24.png"></img>
        
        
        
        <div class="item_introduction"><span class="products__name02">High</span><span class="description02">人体の構造にやさしい洗練されたオフィスチェア</span><span class="price02">￥110,000+</span></div>
        ...
        <form action="./item_cart_a.php" method="post">
          ...
          <div class="modal_pop1">
            ...
            <div id="photo_canvas_id">
                  ...
                  <input type="hidden" name="product_name" value="High">
                  <input type="hidden" name="explanation" value="人体の構造にやさしい洗練されたオフィスチェア">
