...
<html lang="ja">
  <head>
    ...
    <!-- script.jsを読み込む -->
    <script src="../js/script_02_ffd6ff.js"></script>
    <script src="../js/script02_02_d6d6ff.js"></script>
    <script src="../js/script03_02_d6ffff.js"></script>
    <script src="../js/script04_02_d6ffd6.js"></script>
    <script src="../js/script05_02_ffffd6.js"></script>
    <script src="../js/script06_02_ffd6d6.js"></script>
  ...
  <body>
    <div id="global-container">
      <div id="container">
        ...
        <img src="../images/bg_21.png"></img>
        
        
        
        <div class="item_introduction"><span class="products__name02">	Light</span><span class="description02">大人しくスタイリッシュな形状をしたゲーミングチェア</span><span class="price02">￥16,000+</span></div>
        ...
        <form action="./item_cart_a.php" method="post">
          ...
          <div class="modal_pop1">
            ...
            <div id="photo_canvas_id">
                  ...
                  <input type="hidden" name="product_name" value="Light">
                  <input type="hidden" name="explanation" value="大人しくスタイリッシュな形状をしたゲーミングチェア">
