...
<html lang="ja">
  <head>
    ...
    <!-- script.jsを読み込む -->
    <script src="../js/script_04_ffd6ff.js"></script>
    <script src="../js/script02_04_d6d6ff.js"></script>
    <script src="../js/script03_04_d6ffff.js"></script>
    <script src="../js/script04_04_d6ffd6.js"></script>
    <script src="../js/script05_04_ffffd6.js"></script>
    <script src="../js/script06_04_ffd6d6.js"></script>
  ...
  <body>
    <div id="global-container">
      <div id="container">
        ...
        <img src="../images/bg_23.png"></img>
        

        
        <div class="item_introduction"><span class="products__name02">Normal</span><span class="description02">万人受けでとてもスリムな形状置く場所を問わない人気オフィスチェア</span><span class="price02">￥5,000+</span></div>
        ...
        <form action="./item_cart_a.php" method="post">
          ...
          <div class="modal_pop1">
            ...
            <div id="photo_canvas_id">
                  ...
                  <input type="hidden" name="product_name" value="Normal">
                  <input type="hidden" name="explanation" value="万人受けでとてもスリムな形状置く場所を問わない人気オフィスチェア">
