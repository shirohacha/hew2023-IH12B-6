...
<html lang="ja">
  <head>
    ...
    <!-- script.jsを読み込む -->
    <script src="../js/script_06_ffd6ff.js"></script>
    <script src="../js/script02_06_d6d6ff.js"></script>
    <script src="../js/script03_06_d6ffff.js"></script>
    <script src="../js/script04_06_d6ffd6.js"></script>
    <script src="../js/script05_06_ffffd6.js"></script>
    <script src="../js/script06_06_ffd6d6.js"></script>
  ...
  <body>
    <div id="global-container">
      <div id="container">
        ...
        <img src="../images/bg_25.png"></img>
        
        

        <div class="item_introduction"><span class="products__name02">Low</span><span class="description02">小学校のパソコン教室にあった懐かしいオフィスチェア</span><span class="price02">￥1,500+</span></div>
        ...
        <form action="./item_cart_a.php" method="post">
          ...
          <div class="modal_pop1">
            ...
            <div id="photo_canvas_id">
                  ...
                  <input type="hidden" name="product_name" value="Low">
                  <input type="hidden" name="explanation" value="小学校のパソコン教室にあった懐かしいオフィスチェア">
